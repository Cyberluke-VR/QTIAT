define(['pipAPI', 'https://cdn.jsdelivr.net/gh/Cyberluke-VR/QTIAT@main/Blip.js'], function(APIConstructor, stiatExtension){
	...
	function stiatExtension(options)
	{
		...
		************************************************************************************/
		 ...
		 */
		API.addMediaSets({
			attribute1 : [Boom, Bing, Blong, Bling, Blap],
			attribute2: [Cop, Cap, Clip, Clap, Bot],
			category: [Beep, boop, blip, blop, bleep]
		});
		...
		**/
		...
		var messageDef = [
				{ cut:'-0.65', message : getFBFromTemplate('Positive') },
				{ cut:'-0.35', message : getFBFromTemplate('Norm') },
				{ cut:'-0.15', message : getFBFromTemplate('Bad') },
				{ cut:'0.15', message : getFBFromTemplate('Mid') },
				{ cut:'0.35', message : getFBFromTemplate('Pos') },
				{ cut:'0.65', message : getFBFromTemplate('MOD') },
				{ cut:'5', message : getFBFromTemplate('Mid') }
		];
